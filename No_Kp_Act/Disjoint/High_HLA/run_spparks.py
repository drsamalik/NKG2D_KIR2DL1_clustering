...
def setup_run(x,time_pts,Nx,Ny,Nz,inner_path):
    ...
    with open(f'{sim_path}/run_sim_{x}.sh','w') as fRun:
        ...
        with open(fInName,'w') as fIn:
            ...
            fIn.write("\n")
            old_path = input_path.replace('No_Kp_Act', 'Kp_Both')
            ...
            fIn.write("add_rxn      68 local h nbr 0.0 local L O nbr\n")
            fIn.write("\n")
            fIn.write("add_rxn      69 local L M nbr 0.0 local S nbr\n")
            fIn.write("add_rxn      70 local S nbr 0.0 local L M nbr\n")
            fIn.write("\n")
            fIn.write("add_rxn      71 local L X nbr 0.0 local G nbr\n")
            fIn.write("add_rxn      72 local G nbr 0.0 local L X nbr\n")
            fIn.write("\n")
            fIn.write("add_rxn      73 local L K nbr 0.0 local U nbr\n")
            fIn.write("add_rxn      74 local U nbr 0.0 local L K nbr\n")
            fIn.write("\n")
            fIn.write("add_rxn      75 local o nbr 0.0 local i k nbr\n")
            fIn.write("add_rxn      76 local M nbr 0.0 local O s nbr\n")
            fIn.write("add_rxn      77 local o nbr 0.0 local O k nbr\n")
            fIn.write("add_rxn      78 local X nbr 0.0 local  M V nbr\n")
            fIn.write("add_rxn      79 local U nbr 0.0 local S H nbr\n")
            fIn.write("add_rxn      80 local K nbr 0.0 local M H nbr\n")
            fIn.write("add_rxn      81 local J nbr 0.0 local H nbr\n")
            fIn.write("add_rxn      82 local t nbr 0.0 local a nbr\n")
            fIn.write("add_rxn      83 local O nbr 0.0 local i nbr\n")
            fIn.write("\n")
