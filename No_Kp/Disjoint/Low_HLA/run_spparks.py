...
def setup_run(x,time_pts,Nx,Ny,Nz,inner_path):
    ...
    with open(f'{sim_path}/run_sim_{x}.sh','w') as fRun:
        ...
        with open(fInName,'w') as fIn:
            ...
            fIn.write("\n")
            old_path = input_path.replace('No_Kp', 'Kp_Both')
            fIn.write(f"read_sites       {old_path}/input_sppark.nkg2d_kir_ulbp3_hla.disjoint_"+str(x)+"\n")
            fIn.write("\n")
            ...
            fIn.write("#add_rxn      17 local f nbr b 40.0 local nbr f b\n")
            fIn.write("\n")
            fIn.write("# dephospho of free pvav\n")
            fIn.write("add_rxn      17 local f nbr 1.0 local v nbr\n")
            fIn.write("\n")
            fIn.write("# dissociation of Ar complexes \n")
            fIn.write("add_rxn      18 local c nbr 0.0 local l a k nbr\n")
            fIn.write("add_rxn      19 local p nbr 0.0 local l a nbr\n")
            fIn.write("add_rxn      20 local V nbr 0.0 local l a v nbr\n")
            fIn.write("add_rxn      21 local C nbr 0.0 local l a v k nbr\n")
            fIn.write("add_rxn      22 local P nbr 0.0 local l a v nbr\n")
            fIn.write("\n")
            fIn.write("#diffusion\n")
            ...
            fIn.write("add_rxn      42 local G nbr 0.0 local l a v S nbr\n")#
            fIn.write("add_rxn      43 local g nbr 0.0 local L i s v nbr\n")#
            fIn.write("\n")
            fIn.write("#diffusion\n")
            fIn.write("add_rxn      44 local L nbr E 6.25 local nbr L E\n")#
            fIn.write("\n")
            fIn.write("add_rxn      45 local l j nbr 12.3854688 local c nbr\n")#
            fIn.write("add_rxn      46 local c nbr 0.023 local l j nbr\n")#
            fIn.write("\n")
            fIn.write("add_rxn      47 local j nbr 0.006 local a k nbr\n")#
            fIn.write("\n")
            fIn.write("add_rxn      48 local l H nbr 12.3854688 local V nbr\n")#
            fIn.write("add_rxn      49 local V nbr 0.023 local l H nbr\n")#
            fIn.write("\n")
            fIn.write("add_rxn      50 local H nbr 0.01 local t v nbr\n")#
            fIn.write("\n")
            fIn.write("add_rxn      51 local l t nbr 12.3854688 local p nbr\n")#
            fIn.write("add_rxn      52 local p nbr 0.023 local l t nbr\n")#
            fIn.write("\n")
            fIn.write("add_rxn      53 local l e nbr 12.3854688 local C nbr\n")#
            fIn.write("add_rxn      54 local C nbr 0.023 local l e nbr\n")#
            fIn.write("\n")
            fIn.write("add_rxn      55 local e nbr 0.028 local H k nbr\n")#   
            fIn.write("\n")
            fIn.write("add_rxn      56 local e nbr 0.776 local J k nbr\n")#
            fIn.write("\n")
            fIn.write("add_rxn      57 local l J nbr 12.3854688 local P nbr\n")#
            fIn.write("add_rxn      58 local P nbr 0.023 local l J nbr\n")#
            fIn.write("\n")
            fIn.write("add_rxn      59 local l U nbr 12.3854688 local G nbr\n")#
            fIn.write("add_rxn      60 local G nbr 0.023 local l U nbr\n")#
            fIn.write("\n")
            fIn.write("add_rxn      61 local l K nbr 12.3854688 local X nbr\n")#
            fIn.write("add_rxn      62 local X nbr 0.023 local l K nbr\n")#
            fIn.write("\n")
            fIn.write("add_rxn      63 local K nbr 0.01 local M J nbr\n") #
            fIn.write("add_rxn      64 local J nbr 0.01 local t f nbr\n") #
            fIn.write("\n")
            fIn.write("add_rxn      65 local U nbr 0.01 local S J nbr\n")
            fIn.write("add_rxn      66 local U nbr 0.01 local L i s J nbr\n")
            fIn.write("\n")
            fIn.write("add_rxn      67 local U nbr 0.01 local S H nbr\n")
            fIn.write("\n")
            fIn.write("#No Kp on Inh\n")
            fIn.write("add_rxn      68 local L o nbr 50.0 local x nbr\n")
            fIn.write("add_rxn      69 local x nbr 1.0 local L o nbr\n")
            fIn.write("\n")
            fIn.write("add_rxn      70 local L O nbr 50.0 local h nbr\n")
            fIn.write("add_rxn      71 local h nbr 1.0 local L O nbr\n")
            fIn.write("\n")
            fIn.write("add_rxn      72 local L M nbr 50.0 local S nbr\n")
            fIn.write("add_rxn      73 local S nbr 1.0 local L M nbr\n")
            fIn.write("\n")
            fIn.write("add_rxn      74 local L X nbr 50.0 local G nbr\n")
            fIn.write("add_rxn      75 local G nbr 1.0 local L X nbr\n")
            fIn.write("\n")
            fIn.write("add_rxn      76 local L K nbr 50.0 local U nbr\n")
            fIn.write("add_rxn      77 local U nbr 1.0 local L K nbr\n")
            fIn.write("\n")
            fIn.write("add_rxn      78 local o nbr 0.006 local i k nbr\n")
            fIn.write("add_rxn      79 local M nbr 0.0005 local O s nbr\n")
            fIn.write("add_rxn      80 local o nbr 2.189 local O k nbr\n")
            fIn.write("add_rxn      81 local X nbr 10.0 local  M V nbr\n")
            fIn.write("add_rxn      82 local U nbr 10.0 local S H nbr\n")
            fIn.write("add_rxn      83 local K nbr 10.0 local M H nbr\n")
            fIn.write("add_rxn      84 local J nbr 1.0 local H nbr\n")
            fIn.write("add_rxn      85 local t nbr 2.0 local a nbr\n")
            fIn.write("add_rxn      86 local O nbr 2.0 local i nbr\n")
            fIn.write("\n")
