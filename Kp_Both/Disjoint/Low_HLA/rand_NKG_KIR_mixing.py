...
def disjoint_mixing(ensemble,dim,in_pxl,current_path):
    ...
    np.savetxt(f'{current_path}/Init_files/NKG_KIR_disjoint_mixing_iter_{ensemble}.txt', Mix_cluters, fmt='%d')
...
def cluster_plot(NKG_bi_intensity,KIR_bi_intensity,Mix_cluters,ensemble):
    ...
    plt.tight_layout() 
    plt.savefig(f'/home/gddaslab/sxa126/NKR_Nano_Clustering/KMC_Cluster_evol/KMC_diff_time/Mixed_Init_File/NKG_KIR_disjoint_mixing_iter_{ensemble}.png')