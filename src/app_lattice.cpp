...
// Vav homogenized diffusion tau = l^2/D; = 1.82*1.82/10 = 0.33124; here, l = half the length of sim box which is 3.64 micron.
    int time_count_vav = 0;
    if (time > (0.33124 * diff_tau_multiple)) {
      ...
      if (time_count_vav >= 1) {
        ...
        /*avg_cyt_vav = total_cyt_vav/8281; 
        ...
        while (kkk < total_cyt_vav) {
           int r1 = 0;
           r1 = (rand() % 8281);
           if (population[1][r1] != 0 ) {
...
// Vav' homogenized diffusion tau = l^2/D; = 8.5*8.5/10 = 7.225; here, l = half the length of sim box which is 17 micron.
// pVav homogenized diffusion tau = l^2/D; = 1.82*1.82/10 = 0.33124; here, l = half the length of sim box which is 3.64 micron.
    int time_count_vav_prime = 0;
    if (time > (0.33124* vav_prime_diff_tau_multiple)) {
      ...
      if (time_count_vav_prime >= 1) {
        ...
        for (int kk = 0; kk < 8281; kk++) {
          total_cyt_vav_prime = population[14][kk] +total_cyt_vav_prime;
        }
        for (int kk = 0; kk < 8281; kk++) {
          population[14][kk] = 0;
        }
       ...
       /* avg_cyt_vav_prime = total_cyt_vav_prime/8281; 
        ...
        for (int kk = 0; kk < 8281; kk++) {
          if (population[1][kk] != 0) {
            if (population[14][kk] > avg_cyt_vav_prime) {
              int spare_cyt_vav_prime = population[14][kk] - avg_cyt_vav_prime;
              total_spare_cyt_vav_prime = total_spare_cyt_vav_prime + spare_cyt_vav_prime;
              population[14][kk] = avg_cyt_vav_prime;
            } else if (population[14][kk] < avg_cyt_vav_prime) {
              int loss_cyt_vav_prime = avg_cyt_vav_prime - population[14][kk];
       ...
       // remaining_cyt_vav_prime = total_spare_cyt_vav_prime - total_loss_cyt_vav_prime;
        ...
        while (kkk < total_cyt_vav_prime) {
           int r1 = 0;
           r1 = (rand() % 8281);
           if (population[1][r1] != 0 ) {
             population[14][r1] = population[14][r1] +1;
             kkk = kkk+1;
           }
        }
      }
...
// Shp homogenized diffusion tau = l^2/D; = 1.82*1.82/10 = 0.33124; here, l = half the length of sim box which is 3.64 micron.
    int time_count_shp = 0;
    if (time > (0.33124* shp_diff_tau_multiple)) {
      ...
      if (time_count_shp >= 1) {
       ...
       /* avg_cyt_shp = total_cyt_shp/8281; 
        ...
        while (kkk < total_cyt_shp) {
           int r2 = 0;
           r2 = (rand() % 8281) ;
           if (population[1][r2] != 0 ) {
